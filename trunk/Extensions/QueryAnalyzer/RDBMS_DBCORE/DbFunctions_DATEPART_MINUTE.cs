...
namespace RDBMS_DBCORE
{
    ...
    public partial class DbFunctions
    {
        ...
        public static DbValue DATEPART_MINUTE(DbFunctionTools tools, DbFunctionArguments args)
        {
            string FunctionName = "DATEPART_MINUTE";
            ...
            return tools.AllocValue(dt.Minute);
