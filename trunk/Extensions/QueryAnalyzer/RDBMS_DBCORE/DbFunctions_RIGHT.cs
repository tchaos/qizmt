...
namespace RDBMS_DBCORE
{
    ...
    public partial class DbFunctions
    {
        ...
        public static DbValue RIGHT(DbFunctionTools tools, DbFunctionArguments args)
        {
            string FunctionName = "RIGHT";
            ...
            {
                x = x.SubstringM(x.Length - rCount, rCount);
