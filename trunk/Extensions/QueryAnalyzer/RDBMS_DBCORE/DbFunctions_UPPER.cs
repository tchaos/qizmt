...
namespace RDBMS_DBCORE
{
    ...
    public partial class DbFunctions
    {
        ...
        public static DbValue UPPER(DbFunctionTools tools, DbFunctionArguments args)
        {
            string FunctionName = "UPPER";
            ...
            mstring upper = x.ToUpperM();
            return tools.AllocValue(upper);
        }
    }
}
