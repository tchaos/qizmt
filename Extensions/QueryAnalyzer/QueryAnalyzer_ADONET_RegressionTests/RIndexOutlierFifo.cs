...
namespace QueryAnalyzer_ADONET_RegressionTests
{
    ...
    {
        public static void RIndexOutlierFifo()
        {
        ...
        <![CDATA[
            public virtual void Local()
            {
                ...
                using (DbConnection conn = fact.CreateConnection())
                {
                    ...
                    conn.Open();
                    DbCommand cmd = conn.CreateCommand();
                    cmd.CommandText = `create rindex " + indexname + @" from " + tablename + @" pinmemoryHASH OUTLIER Fifo 3 ON id`;
                    cmd.ExecuteNonQuery();
                    conn.Close();
                }         
        }
...

            {
                ...
                expected.Add(new KeyValuePair<int, int>(-2, 3));
                expected.Add(new KeyValuePair<int, int>(-2, 4));

                expected.Add(new KeyValuePair<int, int>(5, 1));
                expected.Add(new KeyValuePair<int, int>(5, 2));

                expected.Add(new KeyValuePair<int, int>(5, 4));
                expected.Add(new KeyValuePair<int, int>(5, 5));
                expected.Add(new KeyValuePair<int, int>(5, 6));

                expected.Add(new KeyValuePair<int, int>(6, 1));
                expected.Add(new KeyValuePair<int, int>(6, 2));

                expected.Add(new KeyValuePair<int, int>(8, 2));
                expected.Add(new KeyValuePair<int, int>(8, 3));
                expected.Add(new KeyValuePair<int, int>(8, 4));                
                ...
                expected.Add(new KeyValuePair<int, int>(20, 4));
                expected.Add(new KeyValuePair<int, int>(20, 5));
                expected.Add(new KeyValuePair<int, int>(20, 6));
                ...
                expected.Add(new KeyValuePair<int, int>(22, 2));
                expected.Add(new KeyValuePair<int, int>(22, 3));
                expected.Add(new KeyValuePair<int, int>(22, 4));

                expected.Add(new KeyValuePair<int, int>(30, 5));
                expected.Add(new KeyValuePair<int, int>(30, 6));
                expected.Add(new KeyValuePair<int, int>(30, 7));
