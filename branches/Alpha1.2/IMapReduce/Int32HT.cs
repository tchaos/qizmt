...
namespace MySpace.DataMining.DistributedObjects
{
	...
	public class Int32HT
	{
		...
		public Int32HT(int maxentries, int hashsize)
			: this(maxentries, hashsize, 0)
		{
		}

		public Int32HT(int maxvalues)
